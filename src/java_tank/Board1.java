...
public class Board1 extends JPanel implements Runnable, Commons {
    private Dimension d;
   ...
   public void gameInit() {
     ...
     // ve thanh bao ve tuong     
       for (int i=0; i < 1; i++) {
        ...
        for (int i=0; i < 1; i++) {
            for (int j=0; j <8 ; j++) {
                Wall wall = new Wall(200+25*j,200);
                 walls.add(wall);
            }
          }
       for (int i=0; i < 5; i++) {
       ...
       for (int i=0; i < 5; i++) {
            for (int j=0; j <1 ; j++) {
                River river= new River(25*i, 250);
                 rivers.add(river);
            }
          }
       for (int i=0; i < 8; i++) {
            for (int j=0; j <1 ; j++) {
                River river= new River(150,75+25*i);
                 rivers.add(river);
            }
          }
   ...
   public void drawBoss(Graphics g) {
    ...
    public void paint(Graphics g)
    {
      ...
      g.drawString("Misson2",BOARD_WIDTH-BORDER_RIGHT+1 , 10);
   ...
   public void run() {
      ...
      if(control!=6){
       ...
       if(control==4){
        ...
        board2.fr2=new JFrame("Game tank");
         board2.fr2.add(board2);
        board2.fr2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        board2.fr2.setSize(BOARD_WIDTH,BOARD_HEIGHT );
        board2.fr2.setLocationRelativeTo(null);
        board2.fr2.setVisible(true);
        board2.fr2.setResizable(false);
        this.fr1.setVisible(false);    
