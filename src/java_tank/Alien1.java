...
public class Alien1 extends State implements Commons{
    private Bomb bomb;
    private  String shot = "hinhanh/E26.jpg";
    ...
    public void act(int direction,ArrayList walls,ArrayList steelwalls,ArrayList rivers,Player player,
       ...
       Random generator = new Random();
         ...
         {
          this.y-=1;
         setShot("hinhanh/E25.jpg");
         ImageIcon ii = new ImageIcon(getShot());
         setImage(ii.getImage());}
         if(direction==LEFT) 
         {
          this.x-=1;
         setShot("hinhanh/E27.jpg");
         ImageIcon ii = new ImageIcon(getShot());
         setImage(ii.getImage());
         }
         if(direction==RIGHT) 
