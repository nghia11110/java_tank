...
public class Board2 extends JPanel implements Runnable, Commons {
    private Dimension d;
   ...
   public void gameInit() {
        ...
        rivers=new ArrayList();
                ...
                Alien4 alien2 = new Alien4(BOARD_WIDTH-BORDER_RIGHT-25, 5);
                aliens2.add(alien2);
                Alien.add(alien2);
                
                Alien4 alien3 = new Alien4(200, 5);
                aliens3.add(alien3);
                Alien.add(alien3);
     ...
     // ve thanh bao ve tuong     
       for (int i=0; i < 1; i++) {
        ...
        for (int i=0; i < 1; i++) {
            for (int j=0; j <7 ; j++) {
                Wall wall = new Wall(30,50+25*j);
                 walls.add(wall);
            }
          }
        for (int i=0; i < 1; i++) {
            for (int j=0; j <7 ; j++) {
                Wall wall = new Wall(BOARD_WIDTH-BORDER_RIGHT-50,25+25*j);
                 walls.add(wall);
            }
          }
       for (int i=0; i < 5; i++) {
            for (int j=0; j <1 ; j++) {
                Steelwall steelwall = new Steelwall(25*i, 200);
                steelwalls.add(steelwall);
            }
          }
       for (int i=0; i < 3; i++) {
            for (int j=0; j <1 ; j++) {
                Steelwall steelwall = new Steelwall(BOARD_WIDTH-BORDER_RIGHT-75+25*i, 200);
                steelwalls.add(steelwall);
            }
          }
        for (int i=0; i < 5; i++) {
   ...
   public void drawBoss(Graphics g) {
    ...
    public void paint(Graphics g)
    {
      ...
      g.drawString("Misson3",BOARD_WIDTH-BORDER_RIGHT+1 , 10);
