...
public class Alien extends State implements Commons{
    private Bomb bomb;
    private  String shot = "hinhanh/E22.jpg";
    ...
    public void act(int direction,ArrayList walls,ArrayList steelwalls,ArrayList rivers,Player player,
       ...
       Random generator = new Random();
         ...
         {
          this.y-=1;
         setShot("hinhanh/E21.jpg");
         ImageIcon ii = new ImageIcon(getShot());
         setImage(ii.getImage());}
         if(direction==LEFT) 
         {
          this.x-=1;
         setShot("hinhanh/E23.jpg");
         ImageIcon ii = new ImageIcon(getShot());
         setImage(ii.getImage());
         }
         if(direction==RIGHT)
